...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
/* zhangchao@cam.algo.[5195022],2023/07/14 add for oplusPD */
struct STRUCT_CAM_CAL_PDAF_STRUCT_EXT {
    unsigned int ver_l_offset;
    unsigned int ver_size;
    unsigned int step1_h_gain_offset;
    unsigned int step1_h_gain_size;
    unsigned int step2_h_dcc_offset;
    unsigned int step2_h_dcc_size;
    unsigned int step1_v_gain_offset;
    unsigned int step1_v_gain_size;
    unsigned int step2_v_dcc_offset;
    unsigned int step2_v_dcc_size;

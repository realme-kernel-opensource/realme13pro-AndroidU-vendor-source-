...
//
/***** ROHM Confidential ***************************************************/
#ifndef SEM1217S_FW_H
#define SEM1217S_FW_H
...
#define SEM1217S_REG_GYRO_X 0x0B04
#define SEM1217S_REG_GYRO_Y 0x0B06
#define SEM1217S_REG_HALL_X 0x0700
#define SEM1217S_REG_HALL_Y 0x0702
#define SEM1217S_REG_GYRO_COMPUTED_X 0x0B08
#define SEM1217S_REG_GYRO_COMPUTED_Y 0x0B0A
#define SEM1217S_REG_SX_OUT 0x0B10
#define SEM1217S_REG_SY_OUT 0x0B12
#define SEM1217S_REG_STATMON_CTRL 0x0B00
#define SEM1217S_REG_SLEEP_MODE 0x0080

#define CAM_OIS "cam_ois"
#define CAM_ERR(__module, fmt, args...)                                        \
	pr_info(__module " [%s] " fmt, __func__, ##args)

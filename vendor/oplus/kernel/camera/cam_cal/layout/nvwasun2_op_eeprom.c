...
static unsigned int do_single_lsc_nvwasun2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_nvwasun2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_nvwasun2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01480126, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000000, 0x00000010, do_part_number},
		{0x00000001, 0x00004000, 0x0000074C, do_single_lsc_nvwasun2},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_nvwasun2}, //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_nvwasun2}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT nvwasun2_op_eeprom = {
	.name = "nvwasun2_op_eeprom",

...
static unsigned int do_single_lsc_nvwatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_nvwatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_nvwatele(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0000C006, 0x00E90114, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x0000C000, 0x00000000, do_module_version},
		{0x00000001, 0x0000C005, 0x00000002, do_part_number},
		{0x00000001, 0x0000CB00, 0x0000074C, do_single_lsc_nvwatele},
		{0x00000001, 0x0000C020, 0x0000000E, do_2a_gain_nvwatele}, //Start address, block size is useless
		{0x00000001, 0x0000D300, 0x000005EE, do_pdaf},
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000001, 0x0000C000, 0x00004000, do_dump_all},
		{0x00000001, 0x0000C008, 0x00000002, do_lens_id_nvwatele}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT nvwatele_op_eeprom = {
	.name = "nvwatele_op_eeprom",

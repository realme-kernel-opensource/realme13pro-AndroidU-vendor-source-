...
static unsigned int do_single_lsc_nvwamain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_nvwamain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_nvwamain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_nvwamain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x015E012C, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000002, do_module_version},
		{0x00000001, 0x00000000, 0x00000011, do_part_number},
		{0x00000001, 0x00004000, 0x0000074C, do_single_lsc_nvwamain},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_nvwamain}, //Start address, block size is useless
		{0x00000001, 0x00005300, 0x00001648, do_pdaf_nvwamain},
		{0x00000001, 0x000005E4, 0x00000012, do_pdaf},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_nvwamain}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT nvwamain_op_eeprom = {
	.name = "nvwamain_op_eeprom",

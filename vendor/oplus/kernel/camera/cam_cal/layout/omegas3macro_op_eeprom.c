...
#define PFX "CAM_CAL_OMEGAS3macro"
...
static unsigned int do_single_lsc_omegas3macro(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_omegas3macro(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_omegas3macro(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000005, 0x0000CA99, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000c00, 0x0000074C, do_single_lsc_omegas3macro},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_omegas3macro},  //Start address, block size is useless
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000001, 0x00000000, 0x00001400, do_dump_all},
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_omegas3macro}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT omegas3macro_op_eeprom = {
	.name = "omegas3macro_op_eeprom",

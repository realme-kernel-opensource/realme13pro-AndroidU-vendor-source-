...
static unsigned int do_single_lsc_nvwafront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_nvwafront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_nvwafront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
    0x00000006, 0x0059000B, CAM_CAL_SINGLE_EEPROM_DATA,
    {
        {0x00000001, 0x00000000, 0x00000000, do_module_version},
        {0x00000001, 0x00000000, 0x00000002, do_part_number},
        {0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_nvwafront},
        {0x00000001, 0x00000007, 0x0000000E, do_2a_gain_nvwafront},  //Start address, block size is useless
        {0x00000001, 0x00001300, 0x000005EC, do_pdaf},
        {0x00000001, 0x00000600, 0x00000006, do_pdaf},
        {0x00000001, 0x00000606, 0x00000376, do_pdaf},
        {0x00000001, 0x00000A00, 0x00000068, do_pdaf},
        {0x00000001, 0x00000A68, 0x00000001, do_pdaf},
        {0x00000001, 0x00000A70, 0x00000001, do_pdaf},
        {0x00000001, 0x00000A72, 0x00000001, do_pdaf},
        {0x00000001, 0x00000A74, 0x00000001, do_pdaf},
        {0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
        {0x00000001, 0x00000000, 0x00004000, do_dump_all},
        {0x00000001, 0x00000008, 0x00000002, do_lens_id_nvwafront}
    }
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT nvwafront_op_eeprom = {
	.name = "nvwafront_op_eeprom",

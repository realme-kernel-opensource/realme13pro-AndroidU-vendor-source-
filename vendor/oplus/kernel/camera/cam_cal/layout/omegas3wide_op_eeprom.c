...
#define PFX "CAM_CAL_OMEGAS3WIDE"
...
static unsigned int do_single_lsc_omegas3wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_omegas3wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_omegas3wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x016D0006, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_omegas3wide},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_omegas3wide},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_omegas3wide}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT omegas3wide_op_eeprom = {
	.name = "omegas3wide_op_eeprom",

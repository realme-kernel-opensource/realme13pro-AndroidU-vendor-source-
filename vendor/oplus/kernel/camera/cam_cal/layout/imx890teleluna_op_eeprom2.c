...
#define PFX "CAM_CAL_IMX890TELELUNA"
...
static unsigned int do_single_lsc_imx890teleluna(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_imx890teleluna(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_imx890teleluna(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0157000F, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x0000299A, 0x0000074C, do_single_lsc_imx890teleluna},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx890teleluna}, //Start address, block size is useless
		{0x00000001, 0x000030F0, 0x00001A68, do_pdaf},
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000001, 0x00000000, 0x00008000, do_dump_all},
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_imx890teleluna}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT imx890teleluna_op_eeprom2 = {
	.name = "imx890teleluna_op_eeprom2",

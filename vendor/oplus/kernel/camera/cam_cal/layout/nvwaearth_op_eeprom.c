...
static unsigned int do_single_lsc_nvwaearth(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_nvwaearth(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_nvwaearth(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01570127, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x0000299A, 0x0000074C, do_single_lsc_nvwaearth},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_nvwaearth}, //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_nvwaearth}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT nvwaearth_op_eeprom = {
	.name = "nvwaearth_op_eeprom",

...
#include "imx800luna_ana_gain_table.h"
#include "imx800luna_Sensor_setting.h"
...
#define PFX "imx800luna_camera_sensor"
...
#define imx800luna_table_write_cmos_sensor_8(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define imx800luna_seq_write_cmos_sensor_8(...) subdrv_i2c_wr_seq_p8(__VA_ARGS__)

#define IMX800LUNA_EEPROM_READ_ID  0xA0
#define IMX800LUNA_EEPROM_WRITE_ID 0xA1
...
{
    if (_size_to_write) {
        imx800luna_table_write_cmos_sensor_8(ctx, _i2c_data, _size_to_write);
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX800LUNA_EEPROM_READ_ID >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}

#define IMX800LUNA_EEPROM_READ_ID_CHECKSUM 0xA0
static bool read_cmos_eeprom_p8_checksum(struct subdrv_ctx *ctx, kal_uint16 addr,
                    BYTE *data, int size)
{
	if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX800LUNA_EEPROM_READ_ID_CHECKSUM >> 1,
			addr, data, size) < 0) {
		return false;
	}
	return true;
...
{
	LOG_INF("imx800 read_otp_info begin\n");
	read_cmos_eeprom_p8_checksum(ctx, 0, otp_data_checksum, OTP_SIZE);
	LOG_INF("imx800 read_otp_info end\n");
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX800LUNA_EEPROM_READ_ID >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1,
...
static kal_int32 write_1st_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    adaptor_i2c_wr_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, 0x0);

    reg = 0x06ca;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, 0x2);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, 0x0);
    }

    adaptor_i2c_rd_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, &flag);
...
static kal_int32 write_2nd_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    ...
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, 0x0E);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX800LUNA_EEPROM_WRITE_ID >> 1, reg, 0x00);
    }
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    u8 flag = 0;
    int ret = 0;
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX800LUNA_EEPROM_READ_ID >> 1, 0x000D, &flag);
    if ( flag == 0x01 ) {
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == IMX800LUNA_SENSOR_ID) && (data_length == CALI_DATA_MASTER_LENGTH)
            && (data_base == IMX800LUNA_STEREO_START_ADDR || data_base == IMX800LUNA_STEREO_MT_START_ADDR)) {
        ...
        } else if ((pStereodata->uSensorId == IMX800LUNA_SENSOR_ID) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX800LUNA_AESYNC_START_ADDR)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+1),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+2),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+3),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+4),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+5),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+6),
                    read_cmos_eeprom_8(ctx, IMX800LUNA_AESYNC_START_ADDR+7));
        ...
        LOG_INF("imx800luna write_Module_data pStereodata is null\n");
        return -1;
    }
    return ret;
}
...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .pre = { /* M3_4096x3072_30FPS Qbin */
        ...
        .mipi_pixel_rate = 582170000,
        .max_framerate = 300,
    },

    .cap = { /* M16-S3_4096x3072_30FPS */
        .pclk = 1890000000,
        .linelength = 9776,
        .framelength = 6444,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        //.mipi_pixel_rate = 798170000,
        .mipi_pixel_rate = 1176690000,
        .max_framerate = 300,
    },

    .normal_video = { /* M5_4096x2304_30FPS  794 Msps/trio */
        .pclk = 1050000000,
        .linelength = 14240,
        .framelength = 2456,
        .startx = 0,
        ...
        .mipi_pixel_rate = 544460000,
        .max_framerate = 300,
    },

    .hs_video = { /* Reg_M14-S2_4096x2304_60FPS */
        .pclk = 1770000000,
        .linelength = 9776,
        .framelength = 3016,
        .startx = 0,
        ...
        .mipi_pixel_rate = 1102630000,
        .max_framerate = 600,
    },

    .slim_video = { /* M9  2048x1152@240fps */
        .pclk = 1818000000,
        .linelength = 5520,
        .framelength = 1372,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1337140000,
        .max_framerate = 2400, /* 240fps */
    },

    .custom1 = { /* M13_4096x2304_120FPS patial PD */
        .pclk = 1860000000,
        .linelength = 5776,
        .framelength = 2682,
        .startx = 0,
        ...
        .grabwindow_height = 2304,
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1728000000,
        .max_framerate = 1200,
    },

    .custom2 = { /* Reg_M2_4096x3072_24FPS RST 39.7MS */
        .pclk = 756000000,
        .linelength = 9776,
        .framelength = 3222,
        .startx = 0,
        ...
        .mipi_pixel_rate = 480340000,
        .max_framerate = 240,
    },

    .custom3 = {  /* M1 8192x6144_30FPS remosaic*/
        .pclk = 2196000000,
        .linelength = 11536,
        .framelength = 6345,
        .startx = 0,
        ...
        .mipi_pixel_rate = 2238170000,
        .max_framerate = 300,
    },

    .custom4 = { /* M15-S2 4096x2304_60FPS, full-crop  for insensorzoom */
        .pclk = 1770000000,
        .linelength = 11536,
        .framelength = 2557,
        .startx = 0,
    ...
    .custom5 = { /* M18-S3_4096x3072_30FPS for insensor zoom*/
        .pclk = 1890000000,
        .linelength = 11536,
        .framelength = 5461,
        .startx = 0,
    ...
    .custom6 = { /* M10  1296x736@480fps */
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1514060000,
        .max_framerate = 4800, /* 480fps */
    },

    .custom7 = { /* Reg_M11-S1_4096x2304_30FPS, 1DOL video for preISP seamless for custom8*/
        .pclk = 1440000000,
        .linelength = 9776,
        .framelength = 4908,
        .startx = 0,
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        //.mipi_pixel_rate = 880457143,
        .mipi_pixel_rate = 890740000,
        .max_framerate = 300,
    },

    .custom8 = { /* Reg_M12-S1 4096x2304_30FPS, 2DOL Video for preISP, SEAMLESS FOR CUSTOM7 */
        .pclk = 1440000000,
        .linelength = 9776,
        .framelength = 2452,
        .startx = 0,
...
static kal_uint8 imx800luna_QSC_setting[QSC_SIZE];
#else
static kal_uint16 imx800luna_QSC_setting[QSC_TABLE_SIZE];
#endif
...
static void imx800luna_get_pdaf_reg_setting(struct subdrv_ctx *ctx,
...
static void imx800luna_set_pdaf_reg_setting(struct subdrv_ctx *ctx,
        MUINT32 regNum, kal_uint16 *regDa)
{
    imx800luna_table_write_cmos_sensor_8(ctx, regDa, regNum*2);
}
...
#if SEQUENTIAL_WRITE_EN
        //imx800luna_QSC_setting[idx] = read_cmos_eeprom_8(ctx, addr_qsc);
        read_cmos_eeprom_p8(ctx, addr_qsc, imx800luna_QSC_setting, QSC_SIZE);
#else
        read_cmos_eeprom_p8(ctx, addr_qsc, tmp_QSC_setting, QSC_SIZE);
        for (idx = 0; idx < QSC_SIZE; idx++) {
        sensor_qsc = QSC_OTP_ADDR + idx;
        imx800luna_QSC_setting[2 * idx] = sensor_qsc;
        imx800luna_QSC_setting[2 * idx + 1] = tmp_QSC_setting[idx];
        }
#endif
    } else {
...
#if SEQUENTIAL_WRITE_EN
        imx800luna_seq_write_cmos_sensor_8(ctx, QSC_OTP_ADDR,
        imx800luna_QSC_setting, sizeof(imx800luna_QSC_setting));
#else
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_QSC_setting,
        sizeof(imx800luna_QSC_setting) / sizeof(kal_uint16));
#endif
    }
    write_cmos_sensor_8(ctx, 0x32D2, 0x01);
}

static BYTE imx800luna_common_data[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
static void read_module_data(struct subdrv_ctx *ctx)
{
    kal_uint16 idx = 0;
    read_imx800luna_eeprom_info(ctx, EEPROM_META_MODULE_ID,
                &(imx800luna_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx800luna_common_data[1] << 8) |
                   imx800luna_common_data[0];
    read_imx800luna_eeprom_info(ctx, EEPROM_META_SENSOR_ID,
                &(imx800luna_common_data[2]), 2);
    read_imx800luna_eeprom_info(ctx, EEPROM_META_LENS_ID,
                &(imx800luna_common_data[4]), 2);
    read_imx800luna_eeprom_info(ctx, EEPROM_META_VCM_ID,
                &(imx800luna_common_data[6]), 2);
    read_imx800luna_eeprom_info(ctx, EEPROM_META_MODULE_SN,
                &(imx800luna_common_data[8]), 17);
    read_imx800luna_eeprom_info(ctx, EEPROM_META_AF_CODE,
                &(imx800luna_common_data[25]), 6);

    for (idx = 0; idx < 32; idx = idx + 4)
        LOG_INF("In %s:cam data: %02x %02x %02x %02x\n", __func__,
               imx800luna_common_data[idx], imx800luna_common_data[idx + 1],
               imx800luna_common_data[idx + 2],
               imx800luna_common_data[idx + 3]);

    imx800luna_common_data[25] = (kal_uint8)((imx800luna_common_data[26] << 6) | (imx800luna_common_data[25] >> 2));
    imx800luna_common_data[26] = (kal_uint8)(imx800luna_common_data[26] >> 2);
    imx800luna_common_data[27] = (kal_uint8)((imx800luna_common_data[28] << 6) | (imx800luna_common_data[27] >> 2));
    imx800luna_common_data[28] = (kal_uint8)(imx800luna_common_data[28] >> 2);
    imx800luna_common_data[29] = (kal_uint8)((imx800luna_common_data[30] << 6) | (imx800luna_common_data[29] >> 2));
    imx800luna_common_data[30] = (kal_uint8)(imx800luna_common_data[30] >> 2);
}
...
#ifdef USE_GAIN_TABLE
    reg_gain = imx800luna_gain_reg[IMX800LUNA_GAIN_TABLE_SIZE - 1];
    for (i = 0; i < IMX800LUNA_GAIN_TABLE_SIZE; i++) {
        if (gain_value <= imx800luna_gain_ratio[i]) {
            reg_gain = imx800luna_gain_reg[i];
            break;
        }
    }
#else
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_init_setting,
        sizeof(imx800luna_init_setting)/sizeof(kal_uint16));
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_preview_setting,
        sizeof(imx800luna_preview_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_capture_setting,
        sizeof(imx800luna_capture_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_normal_video_setting,
        sizeof(imx800luna_normal_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_hs_video_setting,
        sizeof(imx800luna_hs_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_slim_video_setting,
        sizeof(imx800luna_slim_video_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom1_setting,
        sizeof(imx800luna_custom1_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom2_setting,
        sizeof(imx800luna_custom2_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom3_setting,
        sizeof(imx800luna_custom3_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom4_setting,
        sizeof(imx800luna_custom4_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom5_setting,
        sizeof(imx800luna_custom5_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom6_setting,
        sizeof(imx800luna_custom6_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom7_setting,
        sizeof(imx800luna_custom7_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom8_setting,
        sizeof(imx800luna_custom8_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
    LOG_INF("E\n");
    imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_custom9_setting,
        sizeof(imx800luna_custom9_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
unsigned short imx800luna_seamless_custom5_Optimize1[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM7:
    {
        unsigned short imx800luna_seamless_custom7[] = {
            0x0340, 0x12,
            0x0341, 0xBA,
            0x0202, 0x12,
            0x0203, 0x8A,
        ...
        FMC_GPH_START;
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_seamless_custom7,
                sizeof(imx800luna_seamless_custom7) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_CUSTOM8:
    {
        unsigned short imx800luna_seamless_custom8[] = {
            0x0340, 0x09,
            0x0341, 0x5C,
            0x0202, 0x07,
            0x0203, 0xE0,
        ...
        FMC_GPH_START;
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_seamless_custom8,
                sizeof(imx800luna_seamless_custom8) / sizeof(kal_uint16));
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_seamless_custom5,
                sizeof(imx800luna_seamless_custom5) / sizeof(kal_uint16));
        ...
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_seamless_custom5_Optimize1, sizeof(imx800luna_seamless_custom5_Optimize1)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx800luna_table_write_cmos_sensor_8(ctx, imx800luna_seamless_normal_preview,
                 sizeof(imx800luna_seamless_normal_preview) / sizeof(kal_uint16));
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(ctx, 0x0016) << 8)
            ...
            LOG_INF("i2c write id: 0x%x, real sensor id: 0x%x\n",
                    ctx->i2c_write_id, *sensor_id);
            if ( (*sensor_id == 0x0866) || (*sensor_id == 0x0800) ) {
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        {
            ...
            *feature_para_len = sizeof(otp_data_checksum);
            break;
        }
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx800luna_ana_gain_table);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx800luna_ana_gain_table,
            sizeof(imx800luna_ana_gain_table));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_MODULE_INFO:
        *feature_return_para_32++ = (imx800luna_common_data[1] << 24) |
                        (imx800luna_common_data[0] << 16) |
                        (imx800luna_common_data[3] << 8) |
                        (imx800luna_common_data[2] & 0xFF);
        *feature_return_para_32 = (imx800luna_common_data[5] << 24) |
                      (imx800luna_common_data[4] << 16) |
                      (imx800luna_common_data[7] << 8) |
                      (imx800luna_common_data[6] & 0xFF);
        *feature_para_len = 8;
        LOG_INF("imx800luna GET_MODULE_CamInfo:%d %d\n", *feature_para_len,
            *feature_data_32);
        break;

    case SENSOR_FEATURE_GET_MODULE_SN:
        *feature_return_para_32++ = (imx800luna_common_data[11] << 24) |
                        (imx800luna_common_data[10] << 16) |
                        (imx800luna_common_data[9] << 8) |
                        (imx800luna_common_data[8] & 0xFF);
        *feature_para_len = 4;
        LOG_INF("imx800luna GET_MODULE_SN:%d %d\n", *feature_para_len,
            *feature_data_32);
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, imx800luna_common_data,
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_imx800luna_eeprom_info(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        case EEPROM_STEREODATA_MW_MAIN:
        default:
            read_imx800luna_eeprom_info(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        }
        break;
    ...
    case SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS:
        ...
        LOG_DEBUG("SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS %lld %d\n",
    ...
    */
    ...
    case SENSOR_FEATURE_GET_STAGGER_MAX_EXP_TIME:
        if (*feature_data == SENSOR_SCENARIO_ID_CUSTOM1) {
            // see IMX800LUNA SRM, table 5-22 constraints of COARSE_INTEG_TIME
            switch (*(feature_data + 1)) {
            case VC_STAGGER_NE:
            case VC_STAGGER_ME:
            case VC_STAGGER_SE:
    ...
    case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
        LOG_DEBUG("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
            (*feature_para_len));
        imx800luna_get_pdaf_reg_setting(ctx, (*feature_para_len) / sizeof(UINT32)
                       , feature_data_16);
        break;
    case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
        imx800luna_set_pdaf_reg_setting(ctx, (*feature_para_len) / sizeof(UINT32)
                       , feature_data_16);
        break;
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        ...
        LOG_INF("IMX800LUNA SENSOR_FEATURE_GET_BINNING_TYPE AE_binning_type:%d,\n",
    ...
    case SENSOR_FEATURE_GET_CUST_PIXEL_RATE:
		LOG_INF("SENSOR_FEATURE_GET_CUST_PIXEL_RATE setting = %llu", *feature_data);
        switch (*feature_data) {
            case SENSOR_SCENARIO_ID_CUSTOM9:
...
/*Reg M15  seamless M14  4k 60 full crop*/
...
const struct subdrv_entry imx800luna_mipi_raw_entry = {
    .name = "imx800luna_mipi_raw",
    .id = IMX800LUNA_SENSOR_ID,
    .pw_seq = pw_seq,

...
static int imx709luna_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx709luna_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx709luna_check_sensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx709luna_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx709luna_get_otp_checksum_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int imx709luna_open(struct subdrv_ctx *ctx)
{
	...
	i2c_table_write(ctx, imx709luna_rmsc_ip_setting, rmsc_ip_setting_len);

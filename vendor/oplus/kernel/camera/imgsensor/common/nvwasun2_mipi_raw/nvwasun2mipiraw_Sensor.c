 ...
 *============================================================================
 ****************************************************************************/
#include "nvwasun2mipiraw_Sensor.h"

#define NVWASUN2_EEPROM_READ_ID	0xA0
#define NVWASUN2_EEPROM_WRITE_ID	0xA1
#define NVWASUN2_MAX_OFFSET		0x8000
#define OPLUS_CAMERA_COMMON_DATA_LENGTH 40
#define PFX "nvwasun2_camera_sensor"
...
static int nvwasun2_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_check_sensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_set_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_get_otp_checksum_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int nvwasun2_get_cust_pixel_rate(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int open(struct subdrv_ctx *ctx);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int vsync_notify(struct subdrv_ctx *ctx,	unsigned int sof_cnt);
static int nvwasun2_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static BYTE nvwasun2_common_data[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
...
static struct comp_mode_tran_time_params nvwasun2_comp_params[SENSOR_SCENARIO_ID_MAX] = {
	{ .enable = 0, }, /*pre*/
...
static struct eeprom_map_info nvwasun2_eeprom_info[] = {
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, nvwasun2_set_test_pattern},
	{SENSOR_FEATURE_SEAMLESS_SWITCH, nvwasun2_seamless_switch},
	{SENSOR_FEATURE_CHECK_SENSOR_ID, nvwasun2_check_sensor_id},
	{SENSOR_FEATURE_GET_EEPROM_DATA, nvwasun2_get_sensor_sn},
	{SENSOR_FEATURE_SET_SENSOR_OTP, nvwasun2_set_eeprom_calibration},
	{SENSOR_FEATURE_GET_EEPROM_STEREODATA, nvwasun2_get_eeprom_calibration},
	{SENSOR_FEATURE_GET_SENSOR_OTP_ALL, nvwasun2_get_otp_checksum_data},
	{SENSOR_FEATURE_GET_MIN_SHUTTER_BY_SCENARIO, nvwasun2_get_min_shutter_by_scenario_adapter},
	{SENSOR_FEATURE_GET_CUST_PIXEL_RATE, nvwasun2_get_cust_pixel_rate},
	{SENSOR_FEATURE_SET_AWB_GAIN, nvwasun2_set_awb_gain},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{/* Reg_B_4096x3072_30FPS */
		...
		.mode_setting_table = nvwasun2_preview_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_preview_setting),
	...
	{/* Reg_K5-1_4096x3072_30FPS */
		...
		.mode_setting_table = nvwasun2_capture_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_capture_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = nvwasun2_seamless_capture,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(nvwasun2_seamless_capture),
		.hdr_mode = HDR_NONE,
		.pclk = 3014400000,
		.linelength = 15616,
		.framelength = 6434,
	...
	{/* Reg_S_4096x2304_30FPS seamless K*/
		...
		.mode_setting_table = nvwasun2_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_S_1_4096x2304_60FPS */
		...
		.mode_setting_table = nvwasun2_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_M-1 QBIN(HVBIN) - V2H2_FHD_2048x1152_120FPS */
		...
		.mode_setting_table = nvwasun2_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_M_2048x1152_240FPS */
		...
		.mode_setting_table = nvwasun2_custom1_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom1_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* reg_B_2 QBIN(VBIN)_4096x3072 @24FPS  Tline >=8.5us */
		...
		.mode_setting_table = nvwasun2_custom2_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom2_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_A 8192x6144_11FPS remosaic*/
		...
		.mode_setting_table = nvwasun2_custom3_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom3_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_K5 4096x3072_30FPS, 2DOL PREVIEW seamless with capture */
		...
		.mode_setting_table = nvwasun2_custom4_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom4_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = nvwasun2_seamless_custom4,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(nvwasun2_seamless_custom4),
		.hdr_mode = HDR_NONE,
		.pclk = 3014400000,
		.linelength = 15616,
		.framelength = 6432,
	...
	{/* Reg U QRMSC_4096x3072_30FPS for insensor zoom*/
		...
		.mode_setting_table = nvwasun2_custom5_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom5_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_L_1296x736_480FPS */
		...
		.mode_setting_table = nvwasun2_custom6_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom6_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_Q-2-1_4096x2304_30FPS, normal_video for preISP*/
		...
		.mode_setting_table = nvwasun2_custom7_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom7_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = nvwasun2_seamless_custom7,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(nvwasun2_seamless_custom7),
		.hdr_mode = HDR_NONE,
		.pclk = 2246400000,
		.linelength = 15616,
		.framelength = 4794,
	...
	{/* Reg_R-2 4096x2304_30FPS, 2DOL Video for preISP */
		...
		.mode_setting_table = nvwasun2_custom8_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom8_setting),
		.seamless_switch_group = 2,
		.seamless_switch_mode_setting_table = nvwasun2_seamless_custom8,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(nvwasun2_seamless_custom8),
		.hdr_mode = HDR_NONE,
		.pclk = 2246400000,
		.linelength = 15616,
		.framelength = 4792,
	...
	{/* Reg_B_4096x3072_30FPS, for preisp dump*/
		...
		.mode_setting_table = nvwasun2_custom9_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom9_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = nvwasun2_custom10_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom10_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/*reg_N_2
		...
		.mode_setting_table = nvwasun2_custom11_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom11_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_Q-2-1_4096x2304_30FPS; Just for detect the brokenImg in film scenario. */
		.mode_setting_table = nvwasun2_custom12_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom12_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	{/* Reg_Q-2-1_4096x2304_30FPS, normal_video for preISP*/
		...
		.mode_setting_table = nvwasun2_custom13_setting,
		.mode_setting_len = ARRAY_SIZE(nvwasun2_custom13_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	...
	.ana_gain_type = 0,
	.ana_gain_step = 1,
	.ana_gain_table = nvwasun2_ana_gain_table,
	.ana_gain_table_size = sizeof(nvwasun2_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 8,
	...
	.init_setting_table = nvwasun2_init_setting,
	.init_setting_len = ARRAY_SIZE(nvwasun2_init_setting),
	.mode = mode_struct,
...
const struct subdrv_entry nvwasun2_mipi_raw_entry = {
	.name = "nvwasun2_mipi_raw",
	.id = NVWASUN2_SENSOR_ID,
	.pw_seq = pw_seq,
...
static unsigned int read_nvwasun2_eeprom_info(struct subdrv_ctx *ctx, kal_uint16 meta_id,
	BYTE *data, int size)
{
	kal_uint16 addr;
	int readsize;

	if (meta_id != nvwasun2_eeprom_info[meta_id].meta)
		return -1;

	if (size != nvwasun2_eeprom_info[meta_id].size)
		return -1;

	addr = nvwasun2_eeprom_info[meta_id].start;
	readsize = nvwasun2_eeprom_info[meta_id].size;
...
static void read_module_data(struct subdrv_ctx *ctx)
{
	...
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_MODULE_ID,
		&(nvwasun2_common_data[0]), 2);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_SENSOR_ID,
		&(nvwasun2_common_data[2]), 2);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_LENS_ID,
		&(nvwasun2_common_data[4]), 2);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_VCM_ID,
		&(nvwasun2_common_data[6]), 2);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_MODULE_SN,
		&(nvwasun2_common_data[8]), 17);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_AF_CODE,
		&(nvwasun2_common_data[25]), 6);
	read_nvwasun2_eeprom_info(ctx, EEPROM_META_AF_FLAG,
		&(nvwasun2_common_data[33]), 1);

	for (idx = 0; idx < 36; idx = idx + 4)
		DRV_LOG(ctx, "otp data1: %02x %02x %02x %02x\n", nvwasun2_common_data[idx],
			nvwasun2_common_data[idx + 1], nvwasun2_common_data[idx + 2],
			nvwasun2_common_data[idx + 3]);

	nvwasun2_common_data[25] = (kal_uint8)((nvwasun2_common_data[26] << 6) | (nvwasun2_common_data[25] >> 2));
	nvwasun2_common_data[26] = (kal_uint8)(nvwasun2_common_data[26] >> 2);
	nvwasun2_common_data[27] = (kal_uint8)((nvwasun2_common_data[28] << 6) | (nvwasun2_common_data[27] >> 2));
	nvwasun2_common_data[28] = (kal_uint8)(nvwasun2_common_data[28] >> 2);
	nvwasun2_common_data[29] = (kal_uint8)((nvwasun2_common_data[30] << 6) | (nvwasun2_common_data[29] >> 2));
	nvwasun2_common_data[30] = (kal_uint8)(nvwasun2_common_data[30] >> 2);
...
static int nvwasun2_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	memcpy(feature_return_para_32, nvwasun2_common_data,
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
	...
	adaptor_i2c_rd_u8(ctx->i2c_client, NVWASUN2_EEPROM_READ_ID >> 1, addr, (u8 *)&get_byte);
	return get_byte;
}
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, NVWASUN2_EEPROM_WRITE_ID >> 1,
...
static kal_int32 write_1st_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
	...
	adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | NVWASUN2_EEPROM_WRITE_ID) >> 1, reg, 0x0);

	reg = 0x06ca;
	if (enable) {
		adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | NVWASUN2_EEPROM_WRITE_ID) >> 1, reg, 0x2);
	}
	else {
		adaptor_i2c_wr_u8(ctx->i2c_client, (0xB0 | NVWASUN2_EEPROM_WRITE_ID) >> 1, reg, 0x0);
	}

	adaptor_i2c_rd_u8(ctx->i2c_client, NVWASUN2_EEPROM_WRITE_ID >> 1, reg, &flag);
...
static kal_int32 write_2nd_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
	...
	if (enable) {
		adaptor_i2c_wr_u8(ctx->i2c_client, NVWASUN2_EEPROM_WRITE_ID >> 1, reg, 0x0E);
	}
	else {
		adaptor_i2c_wr_u8(ctx->i2c_client, NVWASUN2_EEPROM_WRITE_ID >> 1, reg, 0x00);
	}
...
static kal_int32 write_eeprom_protect(struct subdrv_ctx *ctx, kal_uint16 enable)
{
    u8 flag = 0;
	int ret = 0;
    adaptor_i2c_rd_u8(ctx->i2c_client, NVWASUN2_EEPROM_READ_ID >> 1, 0x000D, &flag);
    if ( flag == 0x01 ) {
    ...
    ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == NVWASUN2_SENSOR_ID) && (data_length == CALI_DATA_MASTER_LENGTH)
            && (data_base == NVWASUN2_STEREO_START_ADDR || data_base == NVWASUN2_STEREO_MT_START_ADDR
            || data_base == NVWASUN2_STEREO_MT_105CM_START_ADDR)) {
        ...
        } else if ((pStereodata->uSensorId == NVWASUN2_SENSOR_ID) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == NVWASUN2_AESYNC_START_ADDR)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+1),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+2),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+3),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+4),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+5),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+6),
                read_cmos_eeprom_8(ctx, NVWASUN2_AESYNC_START_ADDR+7));
        ...
        LOG_INF("nvwasun2 write_Module_data pStereodata is null\n");
        return -1;
    }
    return ret;
}
...
static int nvwasun2_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	case EEPROM_STEREODATA_MT_MAIN:
		read_nvwasun2_eeprom_info(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
				(BYTE *)feature_return_para_32, *len);
		break;
	case EEPROM_STEREODATA_MT_MAIN_105CM:
		read_nvwasun2_eeprom_info(ctx, EEPROM_META_STEREO_MT_MAIN_DATA_105CM,
				(BYTE *)feature_return_para_32, *len);
		break;
	case EEPROM_STEREODATA_MW_MAIN:
	default:
		read_nvwasun2_eeprom_info(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
				(BYTE *)feature_return_para_32, *len);
		break;
	}
	return 0;
...
static bool read_cmos_eeprom_p8(struct subdrv_ctx *ctx, kal_uint16 addr,
                    BYTE *data, int size)
{
	if (adaptor_i2c_rd_p8(ctx->i2c_client, NVWASUN2_EEPROM_READ_ID >> 1,
			addr, data, size) < 0) {
		return false;
	}
	return true;
...
{
	DRV_LOGE(ctx, "nvwasun2 read_otp_info begin\n");
	read_cmos_eeprom_p8(ctx, 0, otp_data_checksum, OTP_SIZE);
	DRV_LOGE(ctx, "nvwasun2 read_otp_info end\n");
}
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			*sensor_id = (subdrv_i2c_rd_u8(ctx, addr_h) << 8) |
			...
			printk("wenjun i2c_write_id(0x%x) sensor_id(0x%x/0x%x)\n",
...
static u16 nvwasun2_feedback_awbgain[] = {
	0x0B8E, 0x01,
	0x0B8F, 0x00,
	0x0B90, 0x02,
	0x0B91, 0x28,
...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	if (ctx->current_scenario_id == SENSOR_SCENARIO_ID_CUSTOM3 || // RMSC
		...
		nvwasun2_feedback_awbgain[5] = r_gain_int;
		nvwasun2_feedback_awbgain[7] = (r_gain - r_gain_int * 512) / 2;
		nvwasun2_feedback_awbgain[9] = b_gain_int;
		nvwasun2_feedback_awbgain[11] = (b_gain - b_gain_int * 512) / 2;
		subdrv_i2c_wr_regs_u8(ctx, nvwasun2_feedback_awbgain,
			ARRAY_SIZE(nvwasun2_feedback_awbgain));
	}
}
...
static int open(struct subdrv_ctx *ctx)
{
	...
	if (g_need_addi_setting == 1) {
		i2c_table_write(ctx, nvwasun2_addition_setting, ARRAY_SIZE(nvwasun2_addition_setting));
	}
...
void nvwasun2_get_min_shutter_by_scenario(struct subdrv_ctx *ctx,
...
int nvwasun2_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	u64 *feature_data = (u64 *) para;
	nvwasun2_get_min_shutter_by_scenario(ctx,
...
static int nvwasun2_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	if (nvwasun2_comp_params[ctx->current_scenario_id].enable &&
		nvwasun2_comp_params[ctx->current_scenario_id].clock_vtpxck > 0 &&
		nvwasun2_comp_params[ctx->current_scenario_id].cal_fn) {
		nvwasun2_comp_params[ctx->current_scenario_id].cal_fn(ctx,
...
static void comp_mode_tran_time_cal1(struct subdrv_ctx *ctx, u32 scenario_id, u32* prsh) {
	...
	*prsh = 0U;
	if (nvwasun2_comp_params[ctx->current_scenario_id].clock_vtpxck == 0) {
	...
	system_delay = SYSTEM_DELAY1 * 1000 * 1000 * 10 /
		nvwasun2_comp_params[ctx->current_scenario_id].clock_vtpxck;

...
static int imx890teleluna_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_check_sensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_get_sensor_sn(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_set_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_get_eeprom_calibration(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_get_otp_checksum_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx890teleluna_get_cust_pixel_rate(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_imgsensor_id(struct subdrv_ctx *ctx, u32 *sensor_id);
static int open(struct subdrv_ctx *ctx);
static int imx890tele_set_awb_gain(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static int imx890teleluna_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	frame_duration -= trs;
	DRV_LOG(ctx, "trs(%llu) frame_duartion(%llu)\n", trs, frame_duration);
...
int imx890teleluna_get_min_shutter_by_scenario_adapter(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	u64 *feature_data = (u64 *) para;

...
/*
 * module: fsm_oplus_pa_manager
 */
void fsm_pa_enable_l(int enable, int mode);
void fsm_pa_enable_r(int enable, int mode);
int fsm_left_top_scene_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_left_top_scene_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_right_buttom_scene_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_right_buttom_scene_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_left_top_switch_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_left_top_switch_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_right_buttom_switch_get(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);
int fsm_right_buttom_switch_put(struct snd_kcontrol *kcontrol,
			struct snd_ctl_elem_value *ucontrol);

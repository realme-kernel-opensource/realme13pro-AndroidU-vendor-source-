...
def main():
    ...
    set_env_from_file('kernel/kernel-6.1/build.config.constants')
    ...
    src_and_targets = [
        ('vendor/aosp_gki/kernel-6.1/aarch64/vmlinux.symvers', 'out/oplus/vmlinux_gki.symvers'),
        ('out_krn/target/product/vnd/obj/KLEAF_OBJ/dist/kernel_device_modules-6.1/mgk_64_k61_kernel_aarch64.user/vmlinux.symvers', 'out/oplus/vmlinux.symvers'),
        ('vendor/aosp_gki/kernel-6.1/aarch64/vmlinux', 'out/oplus/vmlinux'),
    ...
    src_dir_list = [
        ...
        pathlib.Path("out_krn/target/product/vnd/symbols/kernel-6.1/system/lib/modules"),

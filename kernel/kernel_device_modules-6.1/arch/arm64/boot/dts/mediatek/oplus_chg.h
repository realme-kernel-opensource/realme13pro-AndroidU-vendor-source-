...
#define OPLUS_IC_FUNC_CP_ENABLE				(OPLUS_IC_FUNC_NUM_CP_START + 1)
#define OPLUS_IC_FUNC_CP_HW_INTI				(OPLUS_IC_FUNC_NUM_CP_START + 2)
#define OPLUS_IC_FUNC_CP_SET_WORK_MODE				(OPLUS_IC_FUNC_NUM_CP_START + 3)
#define OPLUS_IC_FUNC_CP_GET_WORK_MODE				(OPLUS_IC_FUNC_NUM_CP_START + 4)
#define OPLUS_IC_FUNC_CP_CHECK_WORK_MODE_SUPPORT				(OPLUS_IC_FUNC_NUM_CP_START + 5)
#define OPLUS_IC_FUNC_CP_SET_IIN				(OPLUS_IC_FUNC_NUM_CP_START + 6)
#define OPLUS_IC_FUNC_CP_GET_VIN				(OPLUS_IC_FUNC_NUM_CP_START + 7)
#define OPLUS_IC_FUNC_CP_GET_IIN				(OPLUS_IC_FUNC_NUM_CP_START + 8)
#define OPLUS_IC_FUNC_CP_GET_VOUT				(OPLUS_IC_FUNC_NUM_CP_START + 9)
#define OPLUS_IC_FUNC_CP_GET_IOUT				(OPLUS_IC_FUNC_NUM_CP_START + 10)
#define OPLUS_IC_FUNC_CP_GET_VAC				(OPLUS_IC_FUNC_NUM_CP_START + 11)
#define OPLUS_IC_FUNC_CP_SET_WORK_START				(OPLUS_IC_FUNC_NUM_CP_START + 12)
#define OPLUS_IC_FUNC_CP_GET_WORK_STATUS				(OPLUS_IC_FUNC_NUM_CP_START + 13)
#define OPLUS_IC_FUNC_CP_SET_ADC_ENABLE				(OPLUS_IC_FUNC_NUM_CP_START + 14)
#define OPLUS_IC_FUNC_CP_WATCHDOG_ENABLE				(OPLUS_IC_FUNC_NUM_CP_START + 15)

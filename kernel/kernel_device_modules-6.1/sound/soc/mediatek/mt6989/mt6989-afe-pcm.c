...
static int mt6989_afe_runtime_resume(struct device *dev)
{
	...
	/* set all output port to 32bit */
	regmap_write(afe->regmap, AFE_CONN_24BIT_0, 0x0);
	regmap_write(afe->regmap, AFE_CONN_24BIT_1, 0x0);
	regmap_write(afe->regmap, AFE_CONN_24BIT_2, 0x0);
	regmap_write(afe->regmap, AFE_CONN_24BIT_3, 0x0);
	regmap_write(afe->regmap, AFE_CONN_24BIT_4, 0x0);
	regmap_write(afe->regmap, AFE_CONN_24BIT_5, 0x0);
#else

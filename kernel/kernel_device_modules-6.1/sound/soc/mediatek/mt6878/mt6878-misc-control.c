...
/* Add for FTM test*/
static const char *const mt6878_sgen_spktest_str[] = {
	"Off", "On"
};
#endif
...
#if IS_ENABLED(CONFIG_OPLUS_MTK_AUDIO_EXT)
/* Add for FTM test*/
static int mt6878_sgen_spktest_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}

static int mt6878_sgen_spktest_set(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
#else
		regmap_write(afe->regmap, AFE_SINEGEN_CON0, 0x04704704);
#endif
...
#if IS_ENABLED(CONFIG_OPLUS_MTK_AUDIO_EXT)
/* Add for FTM test*/
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6878_sgen_spktest_str),
				mt6878_sgen_spktest_str),
#endif
};
...
#if IS_ENABLED(CONFIG_OPLUS_MTK_AUDIO_EXT)
/* Add for FTM test*/
	SOC_ENUM_EXT("Audio_SineGen_spktest", mt6878_afe_sgen_enum[7],
			 mt6878_sgen_spktest_get, mt6878_sgen_spktest_set),
#endif

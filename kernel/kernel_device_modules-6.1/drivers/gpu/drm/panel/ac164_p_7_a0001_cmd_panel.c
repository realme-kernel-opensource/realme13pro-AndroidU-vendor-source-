...
#include "ac164_p_7_a0001_cmd_panel.h"
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[LCM] ac164_p_7_a0001 %s START\n", __func__);
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	pr_info("[LCM] %s- lcm, AC164_P_7_A0001, END\n", __func__);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "ac164,p,7,a0001,cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ac164_p_7_a0001_cmd_panel",
		.owner = THIS_MODULE,

...
{
	DDPPR_ERR("FORCE recover CG\n");
	writel_relaxed(0xFFFFFFFF,
		priv->config_regs + DISP_REG_CONFIG_MMSYS_CG_CON0_MT6989 + 0x8);
	writel_relaxed(0xFFFFFFFF,
		priv->config_regs + DISP_REG_CONFIG_MMSYS_CG_CON1_MT6989 + 0x8);
	if (priv->side_config_regs) {
		writel_relaxed(0xFFFFFFFF,
			priv->side_config_regs + DISP_REG_CONFIG_MMSYS_CG_CON0_MT6989 + 0x8);
		writel_relaxed(0xFFFFFFFF,
			priv->side_config_regs + DISP_REG_CONFIG_MMSYS_CG_CON1_MT6989 + 0x8);
	}

	if (priv->ovlsys0_regs) {
		writel_relaxed(0xFFFFFFFF,
			priv->ovlsys0_regs + DISP_REG_CONFIG_OVLSYS_CG_CON0_MT6989 + 0x8);
		writel_relaxed(0xFFFFFFFF,
			priv->ovlsys0_regs + DISP_REG_CONFIG_OVLSYS_CG_CON0_MT6989 + 0x8);
	}
	...
	if (priv->ovlsys1_regs) {
		writel_relaxed(0xFFFFFFFF,
			priv->ovlsys1_regs + DISP_REG_CONFIG_OVLSYS_CG_CON0_MT6989 + 0x8);
		writel_relaxed(0xFFFFFFFF,
			priv->ovlsys1_regs + DISP_REG_CONFIG_OVLSYS_CG_CON0_MT6989 + 0x8);
	}
}

...
typedef bool (*platform_irq_enable_mbox)(struct device *dev);
typedef bool (*platform_irq_disable_mbox)(struct device *dev);
...
struct cmdq_util_platform_fp {
	...
	platform_irq_enable_mbox irq_enable_mbox;
	platform_irq_disable_mbox irq_disable_mbox;
};

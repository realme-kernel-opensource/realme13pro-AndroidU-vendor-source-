...
void cmdq_util_set_fp(struct cmdq_util_platform_fp *cust_cmdq_platform)
{
	...
	cmdq_msg("%s init irq_enable_mbox_ptr:%p irq_disable_mbox_ptr:%p",
		__func__, cmdq_platform->irq_enable_mbox, cmdq_platform->irq_disable_mbox);
	controller_fp.irq_enable_mbox =  cmdq_platform->irq_enable_mbox;
	controller_fp.irq_disable_mbox =  cmdq_platform->irq_disable_mbox;
	cmdq_msg("%s init done irq_enable_mbox_ptr:%p irq_disable_mbox_ptr:%p",
		__func__, controller_fp.irq_enable_mbox, controller_fp.irq_disable_mbox);
